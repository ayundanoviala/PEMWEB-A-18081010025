                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-4 text-right"><a class="btn btn-primary" href="add_barang.php"><i class="fas fa-plus"></i> Tambah Barang</a></div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="col-sm-12">
                                    <table id="table" class="display">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($result)) {
                                                ...
                                                if ($data['stok'] > 0) {
                                                    $stok = '<span class="badge badge-success">Tersedia</span>';
                                                } else {
                                                    $stok = '<span class="badge badge-danger">Tidak Tersedia</span>';
                                                }
                                                echo "<td>" . $stok . "</td>";
                                                echo "<td>" . $data['kategori'] . "</td>";
                                                echo "<td>
                            <div class='btn-group' role='group' aria-label='Basic example'>
  <a href='edit_barang.php?id=$data[idBarang]' class='btn btn-primary'><i class='fas fa-edit'></i></a>
  <a onclick='myFunction()' href='del_barang.php?id=$data[idBarang]' class='btn btn-danger'><i class='fas fa-trash'></i></a>
</div>
                            </td></tr>";
                                            }
                                            ?>
